...
#define IM_VEC2_CLASS_EXTRA                                                 \
        ImVec2(const hg::Vec2& f) { x = f.x; y = f.y; }                     \
        operator hg::Vec2() const { return {x,y}; }

#define IM_VEC4_CLASS_EXTRA                                                 \
        ImVec4(const hg::Vec4& f) { x = f.x; y = f.y; z = f.z; w = f.w; }   \
        operator hg::Vec4() const { return {x,y,z,w}; }                     \
        ImVec4(const hg::Color& f) { x = f.r; y = f.g; z = f.b; w = f.a; }  \
        operator hg::Color() const { return {x,y,z,w}; }
